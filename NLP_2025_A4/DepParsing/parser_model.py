...
class ParserModel(nn.Module):
    ...
    def __init__(self, embeddings, n_features=36,
        ...
        # 1) Weights and Biases from embedding to hidden layer
        ...
        # 3) weights and biases from hidden to logits layer
    ...
    def embedding_lookup(self, w):
        ...
        x = embeddings.view(embeddings.shape[0], -1)  # Flatten the embeddings to (batch_size, n_features * embed_size)
